...
import time
from utils.zobrist_hashing import initialize_zobrist, compute_zobrist_hash

from agents.player import Agent
from utils.array_utils import *
from heuristics.heuristics import *
from utils.func_timeout import func_timeout, FunctionTimedOut
...
class MinimaxAgent(Agent):
    """
    An Agent that uses the Minimax algorithm with alpha-beta pruning to determine the best move.
    ...
    def __repr__(self):
        """
        Returns a string representation of the MinimaxAgent object.
